          ...
          <div className="header-right" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="header-menu">
                ...
                <button className="header-menu-item" onClick={() => handleMenuNavigate('/favorites')}>
                ...
                <button className="header-menu-item" onClick={() => handleMenuNavigate('/collections')}>
                  <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path d="M20 6h-8l-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>
                  Collections
                </button>
